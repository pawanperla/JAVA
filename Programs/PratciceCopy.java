...
public class Pratcice {
    ...
    public static long Kasturba(long x, long y) {
        ...
        long a = x / (long) Math.pow(10, n1), b = x % (long) Math.pow(10, n1), c = y / (long) Math.pow(10, n1),
                d = y % (long) Math.pow(10, n1);
    ...
    public static int MaxSum(int[][] matrix) {
        ...
        for (int i = 1; i < m - 1; i++) {
            for (int j = 1; j < n - 1; j++) {
                curr = (matrix[i - 1][j - 1] + matrix[i - 1][j] + matrix[i - 1][j + 1] + matrix[i][j]
                        + matrix[i + 1][j - 1] + matrix[i + 1][j] + matrix[i + 1][j]);
                max = Math.max(max, curr);
            }
        }
        return max;
    ...
    public static void main(String[] args) {
        ...
        // int q = square / p;
        // int r = square % p;
        // System.out.println((q == r) ? "It is a Kaprekar number" : "It is not a
        // Kaprekar number");
        ...
        // int x2 = in2.nextInt();
        // int y = in2.nextInt();
        // System.out.println((12 * y - x2) >= 0 ? ("Profit = " + (12 * y - x2)) : "Loss
        // = " + (x2 - 12 * y));
        ...
        System.out.println("Resulted number after swapping the two nibbles in the given number = "
